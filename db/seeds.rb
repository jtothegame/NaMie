...
User.new(first_name: "Sarah",
         last_name: "Robins",
         email: "sarah@gmail.com",
         password: "qweqwe",
         password_confirmation: "qweqwe").save(validate: false)
puts "User Sarah created!"
...
baby_names =
  [["Aaron",
    ...
    856],
    ["Bethany",
    "From the name of a biblical town, possibly derived from Hebrew (beit-te'enah) meaning 'house of figs'. In the New Testament the town of Bethany was the home of Lazarus and his sisters Mary and Martha. It has been in use as a rare given name in the English-speaking world since the 19th century, used primarily by Catholics in honour of Mary of Bethany. In America it became moderately common after the 1950s.",
    "F",
    "Beth, Bethney, Bethania",
    "BETH-a-nee",
    460],
    ["Bridget",
    ...
    "F",
    "Bridgette, Bedelia, Biddy, Bee, Brigida, Gitta",
    "BRIJ-et",
    594],
    ["Brittany",
    ...
    "F",
    "Britney, Brittani, Brittney, Brittny, Britannia, Brittania",
    "BRIT-nee, BRIT-a-nee",
    542],
    ["Brooklyn",
    ...
    "F",
    "Brook, Brooke, Brooklynn",
    "BRUWK-lin",
    34],
    ["Camilla",
    "Feminine form of CAMILLUS. This was the name of a legendary warrior maiden of the Volsci, as told by Virgil in the 'Aeneid'. It was popularized in the English-speaking world by Fanny Burney's novel 'Camilla' (1796).",
    "F",
    "Camille, Cammie, Millie, Milly, Milla, Kamila, Camila",
    "ke-MIL-a (English), kah-MEEL-lah (Italian, Danish), KAH-meel-lah (Finnish)",
    342],
    ["Candace",
    "From the hereditary title of the queens of Ethiopia, as mentioned in Acts in the New Testament. It is apparently derived from Cushitic kdke meaning 'queen mother'. In some versions of the Bible it is spelled Kandake. It was used as a given name by the Puritans after the Protestant Reformation. It was popularized in the 20th century by a character in the movie 'Meet the Stewarts' (1942).",
    "F",
    "Candice, Candy, Kandi, Candyce, Candis",
    "KAN-dis, kan-DAY-see, KAN-de-see",
    720],
    ["Cassandra",
    "From the Greek name (Kassandra), derived from possibly (kekasmai) 'to excel, to shine' and (aner) 'man' (genitive). In Greek myth Cassandra was a Trojan princess, the daughter of Priam and Hecuba. She was given the gift of prophecy by Apollo, but when she spurned his advances he cursed her so nobody would believe her prophecies. In the Middle Ages this name was common in England due to the popularity of medieval tales about the Trojan War. It subsequently became rare, but was revived in the 20th century.",
    "F",
    "Kasandra, Cass, Cassie, Kassy",
    "ka-SAN-dra, ka-SAHN-dra, kahs-SAHN-drah (Italian)",
    570],
    ["Cecilia",
    ...
    "F",
    "Cecily, Cece, Celia, Sissy, Silje, Cila, Cecilija",
    "se-SEE-lee-a, se-SEEL-ye, che-CHEE-lyah (Italian), the-THEE-lyah (Spanish), se-SEEL-yah (Danish, Norwegian)",
    178],
    ["Chloe",
    ...
    "F",
    "Christine, Kristina, Chrissy, Kiki, Kristie, Tiana, Tina, Kia, Kristin",
    "kris-TEEN-a (English), kris-TEE-nah (German, Swedish, Dutch)",
    390],
    ["Clara",
    "Feminine form of the Late Latin name Clarus which meant 'clear, bright, famous'. The name Clarus was borne by a few early saints. The feminine form was popularized by the 13th-century Saint Clare of Assisi (called Chiara in Italian), a friend and follower of Saint Francis, who left her wealthy family to found the order of nuns known as the Poor Clares. As an English name it has been in use since the Middle Ages, originally in the form Clare, though the Latinate spelling Clara became more popular in the 19th century.",
    "F",
    "Chiara, Klara, Claire, Claribel, Kiara, Clarette",
    "KLAH-rah (Italian, German, Spanish), KLER-a, KLAR-a",
    99],
    ["Cynthia",
    "Latinized form of Greek (Kynthia) which means 'woman from Kynthos'. This was an epithet of the Greek moon goddess Artemis, given because Kynthos was the mountain on Delos on which she and her twin brother Apollo were born. It was not used as a given name until the Renaissance, and it did not become common in the English-speaking world until the 19th century.",
    "F",
    "Cindi, Cyndy, Sindy, Cinzia",
    "SIN-thee-a",
    561],
    ["Daphne",
    ...
    "F",
    "Darija, Dareia, Darya, Darina",
    "DAHR-yah (Italian, Polish, Romanian), DAHR-ee-a, DER-ee-a, DAR-ee-a",
    449],
    ["Deborah",
    "Means 'bee' in Hebrew. In the Old Testament Book of Judges, Deborah is a heroine and prophetess who leads the Israelites when they are threatened by the Canaanites. She forms an army under the command of Barak, and together they destroy the army of the Canaanite commander Sisera. Also in the Old Testament, this is the name of the nurse of Rebecca. Long a common Jewish name, Deborah was first used by English Christians after the Protestant Reformation, and it was popular among the Puritans.",
    "F",
    "Debra, Devorah, Dvorah, Deb, Debbie, Debbi",
    "DEB-e-ra, DEB-ra",
    814],
    ["Diana",
    ...
    "F",
    "Diane, Dianna, Dijana, Kiana, Dajana",
    "die-AN-a (English), dee-AH-nah (Italian, German, Dutch)",
    269],
    ["Dolores",
    ...
    "F",
    "Delora, Deloris, Lola, Lolita, Dollie, Dolly, Dores",
    "do-LO-res (Spanish), de-LAWR-is (English)",
    774],
    ["Dorothy",
    "Feminine form of the Late Greek name (Dorotheos), which meant 'gift of God' from Greek (doron) 'gift' and (theos) 'god'. Dorothea was the name of two early saints, notably the 4th-century martyr Dorothea of Caesarea. It was also borne by the 14th-century Saint Dorothea of Montau, who was the patron saint of Prussia.",
    "F",
    "Dorte, Thea, Dora, Dorina, Dorotea, Teja, Dorita, Dosia",
    "do-ro-TE-ah (German), dawr-a-THEE-a (English)",
    1121],
    ["Edith",
    ...
    "F",
    "Edythe, Edie, Ditte, Edita, Eda, Edyta",
    "EE-dith (English), E-dit (German, Swedish)",
    488],
    ["Elaine",
    ...
    "F",
    "Em, Emmy, Emmalyn, Ema, Emmi, Ima, Irma",
    "EM-a (English), EM-mah (Finnish), E-mah (German)",
    1],
    ["Esmeralda",
    "Means 'emerald' in Spanish and Portuguese. Victor Hugo used this name in his novel 'The Hunchback of Notre Dame' (1831), in which Esmeralda is the Gypsy girl who is loved by Quasimodo. It has occasionally been used in the English-speaking world since that time.",
    "F",
    "Emerald, Esmaralda",
    "es-me-RAHL-dah (Spanish), esh-me-RAL-da (Portuguese), ez-me-RAHL-da (English)",
    376],
    ["Eva",
    ...
    "F",
    "Evelia, Ava, Eve, Yeva, Evita, Evie, Eveleen, Ewa",
    "E-vah (Spanish, Italian, Danish), EE-va (English), E-fah (German), AY-vah (Dutch)",
    73],
    ["Faith",
    ...
    "F",
    "Flick, Felicitas, Felicita, Felicidade, Zita",
    "fi-LIS-i-tee",
    356],
    ["Flora",
    "Derived from Latin flos meaning 'flower'. Flora was the Roman goddess of flowers and spring, the wife of Zephyr the west wind. It has been used as a given name since the Renaissance, starting in France. In Scotland it was sometimes used as an Anglicized form of Fionnghuala.",
    "F",
    "Flower, Flo, Floretta, Fiorino, Florine, Florinda",
    "FLAWR-a (English), FLO-rah (German)",
    305],
    ["Freya",
    ...
    "F",
    "Freyja, Frea, Frey, Freja, Frejya",
    "FRAY-ah (Norse Mythology), FRAY-ə (English)",
    330],
    ["Gabriella",
    "French feminine form of GABRIEL. This was the real name of French fashion designer Coco Chanel (1883-1971).",
    "F",
    "Brielle, Gabby, Gabriela, Gabi, Gavrila, Gabriella",
    "ga-bree-EL",
    225],
    ["Gemma",
    ...
    "F",
    "Jemma, Gema",
    "JEM-mah (Italian), JEM-a (English), KHE-mah (Dutch)",
    247],
    ["Giselle",
    ...
    "F",
    "Gisselle, Ghislain, Gisela, Gisa, Gizi, Gizella",
    "zhee-ZEL (French), ji-ZEL (English)",
    219],
    ["Gloria",
    "Means 'glory' in Latin. The name first appeared in E. D. E. N. Southworth's novel 'Gloria' (1891) and subsequently in George Bernard Shaw's play 'You Never Can Tell' (1898). It was popularized in the early 20th century by American actress Gloria Swanson (1899-1983). Another famous bearer is feminist Gloria Steinem.",
    "F",
    "Glória, Glòria, Gloría",
    "GLAWR-ee-a (English), glo-REE-ah (Italian), GLAW-ryah (Polish)",
    550],
    ["Hannah",
    "From the Hebrew name (Channah) meaning 'favour' or 'grace'. In the Old Testament this is the name of the wife of Elkanah. Her rival was Elkanah's other wife Peninnah, who had children while Hannah remained barren. After a blessing from Eli she finally became pregnant with Samuel. As an English name, Hannah was not regularly used until after the Protestant Reformation. The Greek and Latin version Anna, which is used in the New Testament, has traditionally been more common as a Christian name.",
    "F",
    "Hanna, Hanne, Chanah, Anna, Anka, Hendel",
    "HAN-a (English), HAH-nah (German)",
    33],
    ["Harper",
    ...
    10],
    ["Hayley",
    "From a surname which was originally derived from the name of an English town (meaning 'hay clearing' from Old English heg 'hay' and leah 'clearing'). It was popularized by the British child actress Hayley Mills, though the name did not become common until over a decade after she first became famous.",
    "F",
    "Hailee, Hailey, Hailie, Haleigh, Haley, Haylee, Hayleigh, Haylie",
    "HAY-lee",
    622],
    ["Helen",
    "English form of the Greek (Helene), probably from Greek (helene) 'torch' or 'corposant', or possibly related to (selene) 'moon'. In Greek mythology Helen was the daughter of Zeus and Leda, whose kidnapping by Paris was the cause of the Trojan War. The name was also borne by the 4th-century Saint Helena, mother of the Roman emperor Constantine, who supposedly found the True Cross during a trip to Jerusalem. The name was originally used among early Christians in honour of the saint, as opposed to the classical character. In England it was commonly spelled Ellen during the Middle Ages, and the spelling Helen was not regularly used until after the Renaissance. A famous bearer was Helen Keller (1880-1968), an American author and lecturer who was both blind and deaf.",
    "F",
    "Ellen, Helena, Elin, Helene, Ella, Ellie, Lena, Nell, Nellie",
    "HEL-en",
    408],
    ["Imogen",
    ...
    98],
    ["Irene",
    "From Greek (Eirene), derived from a word meaning 'peace'. This was the name of the Greek goddess who personified peace, one of the (Horai). It was also borne by several early Christian saints. The name was common in the Byzantine Empire, notably being borne by an 8th-century empress, who was the first woman to lead the empire. She originally served as regent for her son, but later had him killed and ruled alone. This name has traditionally been more popular among Eastern Christians. In the English-speaking world it was not regularly used until the 19th century.",
    "F",
    "Iria, Irina, Eirene, Irja, Ena, Iryna",
    "ie-REEN, ie-REE-nee, ee-RE-ne (Italian), EE-re-ne (Finnish), ee-RE-nu (German)",
    656],
    ["Isabella",
    ...
    "F",
    "Isabel, Isbel, Isabell, Isa, Bella, Izzy, Libby, Zabel",
    "ee-zah-BEL-lah (Italian), iz-a-BEL-a (English)",
    5],
    ["Jade",
    ...
    "F",
    "Jaimie, Jami, Jamie, Jayme, Jayma",
    "JAY-mee",
    463],
    ["Jasmine",
    "From the English word for the climbing plant with fragrant flowers which is used for making perfumes. It is derived from Persian (yasamen) (which is also a Persian name).",
    "F",
    "Jasmin, Jasmyn, Jazmin, Jazmine, Jazmyn, Yasmin, Yasmine, Yazmin, Jessamine, Jessamyn",
    "JAZ-min (English), zhas-MEEN (French)",
    122],
    ["Jean",
    "Medieval English variant of Jehanne (see JANE). It was common in England and Scotland during the Middle Ages, but eventually became rare in England. It was reintroduced to the English-speaking world from Scotland in the 19th century.",
    "F",
    "Janae, Janelle, Janet, Janey, Janie, Jeanie, Jennie, Jenny, Janeka, Jane, Janessa, Janice, Jayne, Jeana",
    "JEEN",
    179],
    ["Jennifer",
    ...
    "F",
    "Jenifer, Jen, Yenifer, Jenna, Jenny, Jennie, Jenessa, Guenevere",
    "JEN-i-fer",
    273],
    ["Jessica",
    "This name was first used in this form by Shakespeare in his play 'The Merchant of Venice' (1596), where it belongs to the daughter of Shylock. Shakespeare probably based it on the biblical name ISCAH, which would have been spelled Jescha in his time. It was not commonly used as a given name until the middle of the 20th century. Notable bearers include actresses Jessica Tandy (1909-1994) and Jessica Lange.",
    "F",
    "Jessika, Yessica, Jess, Jessie, Jessalyn, Iscah, Yiskah, Jescha",
    "JES-i-ka",
    233],
    ["Joanna",
    "English and Polish form of Latin Iohanna, which was derived from Greek (Ioanna), the feminine form of Ioannes. This is the spelling used in the English New Testament, where it belongs to a follower of Jesus who is regarded as a saint. In the Middle Ages in England it was used as a Latinized form of Joan (the usual feminine form of John) and it became common as a given name in the 19th century.",
    "F",
    "Joan, Johanna, Jo, Jojo, Jolene, Jonna",
    "jo-AN-a (English), yaw-AHN-nah (Polish)",
    248],
    ["Julia",
    ...
    "F",
    "Julie, Juliya, Yulia, Jules, Lia, Julita, Yuli, Yuliya",
    "JOO-lee-ə (English), HOO-lyah (Spanish), YUWL-yah (Polish), YOO-lee-yah (Russian)",
    88],
    ["Kate",
    "Diminutive of KATHERINE, often used independently. It has been used in England since the Middle Ages. This was the name of the woman who Petruchio marries and tries to tame in Shakespeare's comedy 'Taming of the Shrew' (1593). A famous bearer is the British actress Kate Winslet.",
    "F",
    "Kat, Kathi, Kathie, Kathy, Kay, Kaye, Kayla, Kaylee, Kaylyn, Kit, Kitty, Kae, Kayleen, Katey, Katie, Katy",
    "KAYT",
    231],
    ["Kayla",
    "Combination of KAY and the popular name suffix la. Use of the name was greatly increased in the 1980s after the character Kayla Brady began appearing on the American soap opera 'Days of Our Lives'.",
    "F",
    "Cailyn, Caleigh, Kaelyn, Kailee, Kailey, Kailyn, Kaleigh, Kaley, Kalie, Kalyn, Kat, Kate, Kathi, Kathie",
    "KAY-la",
    129],
    ["Kelsey",
    ...
    383],
    ["Kiara",
    "Variant of CIARA or CHIARA. This name first became used in 1988 after the singing duo Kiara released their song 'This Time'. It was further popularized by a character in the animated movie 'The Lion King II' (1998).",
    "F",
    "Keara, Keira, Kiarra, Kierra, Kira, Kyra",
    "kee-AHR-a",
    385],
    ["Kimberly",
    "At the present it is usually considered a short form of KIMBERLY, but it in fact predates it as a given name. The author Rudyard Kipling used it for the title hero of his novel 'Kim' (1901), though in this case it was short for KIMBALL. In her novel 'Show Boat' (1926) Edna Ferber used it for a female character who was born on the Mississippi River and was named from the initials of the states Kentucky, Illinois and Mississippi. The name was popularized in America by the actresses Kim Hunter (1922-2002) and Kim Novak, both of whom assumed it as a stage name.",
    "F",
    "Kimberlee, Kimberley, Kimberleigh, Kim, Kimmie, Kimmy, Kimbra, Kym",
    "KIM-ber-lee",
    132],
    ["Kylie",
    "This name arose in Australia, where it is said to mean 'boomerang' in an Australian Aboriginal language. It is more likely a feminine form of KYLE, and it is in this capacity that it began to be used in America in the 1970s. A famous bearer is the Australian singer Kylie Minogue.",
    "F",
    "Kiley, Kylee, Kyleigh, Kilie",
    "KIE-lee",
    83],
    ["Lara",
    "Russian short form of LARISA. It was introduced to the English-speaking world by a character from Boris Pasternak's novel 'Doctor Zhivago' (1957) and the subsequent movie adaptation (1965).",
    "F",
    "Larisa, Larysa, Larissa",
    "LAHR-a, LAH-rah",
    750],
    ["Laura",
    ...
    "F",
    "Lora, Loreen, Lorene, Loretta, Lorinda, Laurinda, Laureen, Laurene, Laurie, Lori, Lorie, Lorri, Lorrie",
    "LAWR-a, LOW-rah",
    346],
    ["Layla",
    ...
    "F",
    "Laraine, Loraine, Lorayne, Lauraine, Lorainne, Lori, Lorie, Lorri, Lorrie",
    "la-RAYN",
    929],
    ["Lucia",
    "Feminine form of LUCIUS. Saint Lucia was a 4th-century martyr from Syracuse. She was said to have had her eyes gouged out, and thus she is the patron saint of the blind. She was widely revered in the Middle Ages, and her name has been used throughout Christian Europe (in various spellings). It has been used in the England since the 12th century, usually in the spellings Lucy or Luce.",
    "F",
    "Luce, Lucinda, Lucy, Lucilla, Lucja, Lucille",
    "loo-CHEE-ah (Italian), LOO-tsee-ah (German), loo-SEE-a",
    213],
    ["Mackenzie",
    "From the Gaelic surname Mac Coinnich, which means 'son of COINNEACH'. A famous bearer of the surname was William Lyon MacKenzie (1795-1861), a Canadian journalist and political rebel. As a feminine given name, it was popularized by the American actress Mackenzie Phillips.",
    "F",
    "Makenzie, Mckenzie, Kenzie",
    "ma-KEN-zee",
    84],
    ["Madison",
    ...
    "F",
    "Maddison, Madisyn, Madyson, Maddie, Maddy",
    "MAD-i-sun",
    15],
    ["Margaret",
    "Derived from Latin Margarita, which was from Greek (margarites) meaning 'pearl', probably ultimately a borrowing from Sanskrit (manyari). Saint Margaret, the patron of expectant mothers, was martyred at Antioch in the 4th century. Later legends told of her escape from a dragon, with which she was often depicted in medieval art. The saint was popular during the Middle Ages, and her name has been widely used in the Christian world. Other saints by this name include a queen of Scotland and a princess of Hungary. It was also borne by Queen Margaret I of Denmark, who united Denmark, Sweden, and Norway in the 14th century. Famous literary bearers include American writer Margaret Mitchell (1900-1949), the author of 'Gone with the Wind', and Canadian writer Margaret Atwood.",
    "F",
    "Madge, Mae, Maggie, Mamie, Marge, Margie, May, Mayme, Meg, Peg, Peggie, Peggy, Midge",
    "MAHR-grit, MAHR-ga-rit",
    139],
    ["Maria",
    "Latin form of Greek Μαρια. Maria is the usual form of the name in many European languages, as well as a secondary form in other languages such as English (where the common spelling is Mary). In some countries, for example Germany, Poland and Italy, Maria is occasionally used as a masculine middle name. This was the name of two ruling queens of Portugal. It was also borne by the Habsburg queen Maria Theresa (1717-1780), whose inheritance of the domains of her father, the Holy Roman Emperor Charles VI, began the War of the Austrian Succession.",
    "F",
    "Marie, Mari, Mariah, Maleah, Mariam, Mariya, Mimi, Mia, Mitzi, Ria, Maritta, Marietta",
    "mah-REE-ah (Italian), ma-REE-e (Catalan, English), MAHR-yah (Polish), MAH-ree-ah (Finnish)",
    113],
    ["Melanie",
    "From Mélanie, the French form of the Latin name Melania, derived from Greek (melaina) meaning 'black, dark'. This was the name of a Roman saint who gave all her wealth to charity in the 5th century. Her grandmother was also a saint with the same name. The name was common in France during the Middle Ages, and was it introduced from there to England, though it eventually became rare. Interest in it was revived by the character Melanie Wilkes from the novel 'Gone with the Wind' (1936) and the subsequent movie adaptation (1939).",
    "F",
    "Melany, Mellony, Malinda, Mindy, Mel, Melina",
    ...
    "F",
    "Melyssa, Lissa, Malinda, Mel, Melina, Melinda, Mindy, Missie, Missy, Melantha",
    "ma-LIS-a",
    256],
    ["Miranda",
    ...
    589],
    ["Morgan",
    "From the Old Welsh masculine name Morcant, which was possibly derived from Welsh mor 'sea' and cant 'circle'. Since the 1980s in America Morgan has been more common for girls than boys, perhaps due to stories of Morgan le Fay or the fame of actress Morgan Fairchild.",
    "F",
    "Morgana, Morgane, Morcant",
    "MAWR-gan",
    133],
    ["Nadia",
    "Variant of NADYA used in the Western world, as well as a variant transcription of the Slavic name. It began to be used in France in the 19th century. The name received a boost in popularity from the Romanian gymnast Nadia Comaneci.",
    "F",
    "Nadine, Nadya, Nadiya, Nadica, Nada, Nadja",
    "NAD-ya, NAHD-ya",
    358],
    ["Naomi",
    "From the Hebrew name (Na'omiy) meaning 'pleasantness'. In the Old Testament this is the name of the mother-in-law of Ruth. After the death of her husband and sons, she returned to Bethlehem with Ruth. There she declared that her name should be Mara (see Ruth 1:20). Though long common as a Jewish name, Naomi was not typically used as an English Christian name until after the Protestant Reformation. A notable bearer is the British model Naomi Campbell.",
    "F",
    "Na'omi, Noemi, Noemie, Nohemi",
    "nay-O-mee, nie-O-mee",
    74],
    ["Natalie",
    "From the Late Latin name Natalia, which meant 'Christmas Day' from Latin natale domini. This was the name of the wife of the 4th-century martyr Saint Adrian of Nicomedia. She is venerated as a saint in the Orthodox Church, and the name has traditionally been more common among Eastern Christians than those in the West. It was popularized in America by actress Natalie Wood (1938-1981), who was born to Russian immigrants.",
    "F",
    "Nathalie, Natalee, Natille, Nat, Natty, Natisha, Natalija, Natalia, Natasza",
    "nat-a-LEE (French), NAT-a-lee (English), NAH-tah-lee (German)",
    31],
    ["Nicole",
    "French feminine form of NICHOLAS, commonly used in the English-speaking world since the middle of the 20th century. A famous bearer is American-Australian actress Nicole Kidman.",
    "F",
    "Nichole, Nikkole, Nicol, Collette, Coline, Nicky, Nikki, Nicki, Nicolette, Nikola",
    "nee-KOL (French), ni-KOL (English)",
    163],
    ["Nora",
    "Short form of HONORA or ELEANOR. Henrik Ibsen used it for a character in his play 'A Doll's House' (1879).",
    "F",
    "Norah, Nell, Leanora, Noor, Eleonora, Norina",
    "NAWR-a (English), NO-rah (German)",
    36],
    ["Olivia",
    ...
    "F",
    "Alivia, Olyvia, Liv, Livia, Livvy, Ollie, Vivi, Oliwia",
    "a-LIV-ee-a (English), o-LEE-vyah (Italian, Spanish), o-LEE-vee-ah (German), O-lee-vee-ah (Finnish)",
    2],
    ["Ophelia",
    "Derived from Greek (ophelos) meaning 'help'. This name was probably created by the 15th-century poet Jacopo Sannazaro for a character in his poem 'Arcadia'. It was borrowed by Shakespeare for his play 'Hamlet' (1600), in which it belongs to Hamlet's lover who eventually goes insane and drowns herself. In spite of this, the name has been used since the 19th century.",
    "F",
    "Ophelie, Ofelia",
    "o-FEEL-ya",
    580],
    ["Patricia",
    "Feminine form of Patricius. In medieval England this spelling appears in Latin documents, but this form was probably not used as the actual name until the 18th century, in Scotland.",
    "F",
    "Patrice, Pat, Patsy, Patti, Tricia, Trish, Trisha, Patrycja",
    "pa-TRISH-a (English), pah-TREE-thyah (Spanish), pah-TREE-syah (Latin American Spanish), pah-TREE-tsee-ah",
    744],
    ["Pearl",
    ...
    "F",
    "Pearle, Pearlie, Perlie, Perlita, Perele",
    "PURL",
    567],
    ["Penelope",
    "Possibly derived from Greek (penelops), a type of duck. Alternatively it could be from (pene) 'threads, weft' and (ops) 'face, eye'. In Homer's epic the 'Odyssey' this is the name of the wife of Odysseus, forced to fend off suitors while her husband is away fighting at Troy. It has occasionally been used as an English given name since the 16th century.",
    "F",
    "Pen, Penny, Pene, Pénélope",
    "pe-NEL-a-pee",
    27],
    ["Phoebe",
    ...
    "F",
    "Cece, Cissy, Pris, Prissy, Sissie, Scilla, Priska, Priscila",
    "pri-SIL-a (English), pree-SHEEL-lah (Italian)",
    474],
    ["Quinn",
    ...
    "F",
    "Rebeccah, Becca, Becky, Beckah, Reba, Bekki",
    "re-BEK-a (English), re-BEK-kah (Italian)",
    207],
    ["Regan",
    ...
    "F",
    "Roberta, Robyn, Robena, Robina, Robynne",
    "RAH-bin",
    654],
    ["Rosa",
    "Generally this can be considered a Latin form of ROSE, though originally it may have come from the Germanic name ROZA. This was the name of a 13th-century saint from Viterbo in Italy. In the English-speaking world it was first used in the 19th century. A famous bearer was civil rights activist Rosa Parks (1913-2005).",
    "F",
    "Rosalia, Rosabel, Rosita, Rosetta, Rosie, Rosy",
    "RO-sah (Spanish, Dutch), RAW-zah (Italian), RO-za (English)",
    639],
    ["Roxana",
    "Latin form of (Roxane), the Greek form of the Persian or Bactrian name (Roshanak) which meant 'bright' or 'dawn'. This was the name of Alexander the Great's first wife, a daughter of the Bactrian nobleman Oxyartes. In the modern era it came into use during the 17th century. In the English-speaking world it was popularized by Daniel Defoe, who used it in his novel 'Roxana' (1724).",
    "F",
    "Roxane, Roxanne, Ruxandra, Roksana, Roxy",
    "rahk-SAN-a (English), rok-SAHN-ah (Spanish)",
    945],
    ["Ruth",
    "From a Hebrew name which was derived from the Hebrew word (re'ut) meaning 'friend'. This is the name of the central character in the Book of Ruth in the Old Testament. She was a Moabite woman who accompanied her mother-in-law Naomi back to Bethlehem after Ruth's husband died. There she met and married Boaz. She was an ancestor of King David. As a Christian name, Ruth has been in use since the Protestant Reformation. It became very popular in America following the birth of 'Baby' Ruth Cleveland (1891-1904), the daughter of President Grover Cleveland.",
    "F",
    "Ruthie, Routh, Ruut, Ruta, Ruf",
    "ROOTH (English), ROOT (German)",
    299],
    ["Sabrina",
    "Latinized form of Habren, the original Welsh name of the River Severn. According to Geoffrey of Monmouth, Sabrina was the name of a princess who was drowned in the Severn. Supposedly the river was named for her, but it is more likely that her name was actually derived from that of the river, which is of unknown meaning. She appears as a water nymph in John Milton's masque 'Comus' (1634). It was popularized as a given name by Samuel A. Taylor's play 'Sabrina Fair' (1953) and the movie adaptation that followed it the next year.",
    "F",
    "Sabryna, Sab",
    "sa-BREEN-a (English), sah-BREE-nah (Italian), zahp-REE-nah (German)",
    370],
    ["Sandra",
    "Short form of ALESSANDRA. It was introduced to the English-speaking world by author George Meredith, who used it for the heroine in his novel 'Emilia in England' (1864) and the reissued version 'Sandra Belloni' (1887). A famous bearer is American actress Sandra Bullock.",
    "F",
    "Alessandra, Alessa, Sondra, Sandrine, Sandy, Aleksandra, Saundra, Szandra",
    "SAHN-drah (Italian, Dutch, Finnish), SAN-dra (English), ZAHN-drah (German)",
    874],
    ["Sarah",
    ...
    "F",
    "Sophie, Sofia, Sophy, Sofiya, Sonja, Zofia",
    "so-FEE-a (English), so-FIE-a (British English), zo-FEE-ah (German)",
    4],
    ["Stella",
    "Means 'star' in Latin. This name was created by the 16th-century poet Sir Philip Sidney for the subject of his collection of sonnets 'Astrophel and Stella'. It was a nickname of a lover of Jonathan Swift, real name Esther Johnson (1681-1728), though it was not commonly used as a given name until the 19th century. It appears in Tennessee Williams' play 'A Streetcar Named Desire' (1947), belonging to the sister of Blanche DuBois and the wife of Stanley Kowalski.",
    "F",
    "Estelle, Estela, Stela, Estrella",
    "STEL-a",
    45],
    ["Sydney",
    ...
    "F",
    "Tereza, Theresia, Tere, Teresita, Teri, Tess, Tessa, Tessie, Terzija",
    "te-RE-sah (Spanish, Polish), te-RE-zah (Italian, German), TE-re-sah (Finnish), ta-REE-sa, ta-REE-za",
    666],
    ["Tiffany",
    ...
    "F",
    "Tiffani, Tiffiny, Tiff, Theophania, Tiphaine",
    "TIF-a-nee",
    557],
    ["Tracy",
    ...
    "F",
    "Tess, Tessa, Tessie, Tracee, Tracey, Traci, Tracie",
    "TRAY-see",
    469],
    ["Trinity",
    ...
    "F",
    "Ursella, Ulla, Ursel, Uschi, Orsolya, Ula, Urska",
    "UR-se-la, UR-sye-la, OOR-soo-lah (Finnish)",
    1170],
    ["Vanessa",
    ...
    "F",
    "Roni, Ronnie, Veronique, Veronika, Nika",
    "ve-RAHN-i-ka",
    413],
    ["Victoria",
    ...
    "F",
    "Viktoria, Tori, Toria, Vic, Vicki, Vickie, Vicky, Vikkie, Latoya, Toya, Viktorija",
    "vik-TAWR-ee-a (English), vik-TO-ree-ah (German)",
    21],
    ["Virginia",
    ...
    "F",
    "Gena, Gina, Geena, Ginger, Ginnie, Jinny, Virgee, Gigi",
    "ver-JIN-ya (English), veer-JEE-nyah (Italian), beer-KHEE-nyah (Spanish)",
    515],
    ["Vivian",
    ...
    "F",
    "Vivyan, Vivi, Viv, Vivien, Bebhionn",
    "VIV-ee-en",
    95],
    ["Wendy",
    ...
    "F",
    "Yolonda, Yolo, Jolanda, Jolana, Jola",
    "yo-LAHN-da",
    1070],
    ["Zara",
